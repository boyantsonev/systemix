...
One loop, four steps, two places where it stops and asks you. This is the operational loop — one turn of the bigger [meta-loop](/docs/concepts/the-meta-loop), and the part that runs on a daily cron today.

<LoopDiagram variant="operational" />
