...
- ~~**Self-advancing autonomy.**~~ Now real, with the line drawn deliberately: `systemix loop` (the runner, cron-able) advances running experiments to **decision-ready** — fresh evidence, evaluated against the dial, a close-proposal card queued. Closing stays human at every tier: the runner proposes, you decide.
