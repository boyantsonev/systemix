...
`npx systemix audit` is the free scan you run yourself, in your own repo. Point it at a codebase with **no design system defined** and it tells you what you already have, where it's inconsistent, and hands you the seed of the fix. It only reads — every file it would create is proposed for your approval.
