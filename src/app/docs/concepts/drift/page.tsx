  ...
  return (
    <article>
      ...
      <section className="mb-10">
        ...
        <p className="text-[14px] text-muted-foreground leading-relaxed mb-3">
          Open <code className="font-mono text-[13px] bg-muted/60 px-1.5 py-0.5 rounded text-foreground">/contract</code> to see all drifted tokens. Click any token to go to <code className="font-mono text-[13px] bg-muted/60 px-1.5 py-0.5 rounded text-foreground">/contract/[slug]</code> — the detail view shows side-by-side colour swatches, the ΔE value, and an inline resolve control. Choose <strong className="text-foreground">code wins</strong> or <strong className="text-foreground">Figma wins</strong>. The decision is written back to the MDX frontmatter (<code className="font-mono text-[13px] bg-muted/60 px-1.5 py-0.5 rounded text-foreground">resolve-decision</code>, <code className="font-mono text-[13px] bg-muted/60 px-1.5 py-0.5 rounded text-foreground">resolved: true</code>) and the quality score updates.
        </p>
        <p className="text-[14px] text-muted-foreground leading-relaxed">
