...
- After synthesis, approve or reject from the HITL queue at /queue.`,
  ...
  // ── The loop — workflow orchestration ────────────────────────────────────
  {
    ...
    category: "pipeline",
    group: "the-loop",
    mcp: { required: ["systemix-mcp"] },
    promptContent: `See ~/.claude/skills/init-experiment/SKILL.md after installing the hypothesis-validation workflow.\n\nInstall: npx systemix workflow add hypothesis-validation`,
  },
  {
    command: "/growth-audit",
    name: "Growth Audit",
    description: "Cross-reference running experiments against PostHog evidence. Scores signal strength (insufficient / weak / strong) and produces a prioritized decision brief. Install: npx systemix workflow add hypothesis-validation",
    file: "~/.claude/skills/growth-audit/SKILL.md",
    triggersAgent: "Hermes",
    category: "pipeline",
    group: "the-loop",
    mcp: { required: ["systemix-mcp"] },
    promptContent: `See ~/.claude/skills/growth-audit/SKILL.md after installing the hypothesis-validation workflow.\n\nInstall: npx systemix workflow add hypothesis-validation`,
  },
  {
    command: "/write-variants",
    name: "Write Variants",
    description: "Generate ICP-calibrated variant copy proposals for a running experiment. Optionally applies the winning variant to the source file. Install: npx systemix workflow add hypothesis-validation",
    file: "~/.claude/skills/write-variants/SKILL.md",
    triggersAgent: "Hermes",
    category: "pipeline",
    group: "the-loop",
    mcp: { required: ["systemix-mcp"] },
    promptContent: `See ~/.claude/skills/write-variants/SKILL.md after installing the hypothesis-validation workflow.\n\nInstall: npx systemix workflow add hypothesis-validation`,
  },
  {
    command: "/close-experiment",
    name: "Close Experiment",
    description: "Record the result, decision, and confidence in the hypothesis contract. Calls contract_write_hypothesis_result and pushes a synthesis card to the HITL queue. Install: npx systemix workflow add hypothesis-validation",
    file: "~/.claude/skills/close-experiment/SKILL.md",
    triggersAgent: "Hermes",
    category: "pipeline",
    group: "the-loop",
    mcp: { required: ["systemix-mcp"] },
    promptContent: `See ~/.claude/skills/close-experiment/SKILL.md after installing the hypothesis-validation workflow.\n\nInstall: npx systemix workflow add hypothesis-validation`,
  },
  // ── Design system ──────────────────────────────────────────────────────────
  {
    command: "/figma",
