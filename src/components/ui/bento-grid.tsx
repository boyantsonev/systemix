  ...
  >
    ...
    <div className="p-4">
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300 lg:group-hover:-translate-y-10">
        <Icon className="h-5 w-5 origin-left transform-gpu text-muted-foreground/60 transition-all duration-300 ease-in-out" />
    ...
    <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-black/3 group-hover:dark:bg-muted/40" />
  </div>
)
